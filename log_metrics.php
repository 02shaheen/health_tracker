    ...
    <div class="Mainbody">
        <div class="health-metrics">
            ...
            <div class="banner-container">
                <img src="WhatsApp Image 2025-01-29 at 4.11.13 PM (1).jpeg" class="banner-image" alt="Health Tracking Banner">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div style="margin-left: 90px; margin-top: 60px;">
                        <img src="WhatsApp Image 2025-01-29 at 4.11.13 PM (4).jpeg" style="height:500px; width:550px;" class="side-image" alt="Health Monitoring">
                    </div>
                </div>
                <div class="col-md-6">
